...
/** Typed SELECT helper: returns an array of rows. */
...
/** Typed SELECT helper: returns a single row or undefined. */
...
/** Typed mutation helper: returns { changes, lastInsertRowid }. */
...
/**
 * @deprecated Use dbSelect<T>(), dbGet<T>(), or dbRun() instead.
 * This helper is unsafe because it switches between .all() and .run()
 * based on a fragile string prefix check, and returns an untyped union.
 */
